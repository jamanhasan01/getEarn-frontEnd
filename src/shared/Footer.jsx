        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 text-center md:text-left">
            <div className="flex justify-center md:justify-start items-center space-x-2">
              <svg
                ...
                fillRule="evenodd"
                clipRule="evenodd"
                className="inline-block fill-current text-secondary"
              >
              ...
              <p className="font-bold text-xl">MicroTask</p>
            </div>
            <p className="text-sm">
              Empowering productivity through innovative solutions.
            </p>
            <p className="text-sm">
          ...
          <div className="space-y-4 text-center md:text-left">
            ...
            <form className="flex flex-col space-y-2">
              ...
              <button
                type="submit"
                className="bg-secondary text-white p-2 rounded hover:bg-opacity-80"
              >
                Subscribe
              </button>
            </form>
